	...
	PK_INFO("%s secure state %d", __func__,
		...
		if (ret != ERROR_NONE) {
			...
			if (is_project(OPPO_19131)||is_project(OPPO_19132)||is_project(OPPO_19133)||is_project(OPPO_19420)
				||is_project(OPPO_20001)||is_project(OPPO_20002)||is_project(OPPO_20003)||is_project(OPPO_20200)||is_project(OPPO_20601)){
...
int imgsensor_set_driver(struct IMGSENSOR_SENSOR *psensor)
{
	...
	if (is_project(OPPO_19040) || is_project(OPPO_20601) || is_project(OPPO_20660) || is_project(OPPO_20611) || is_project(OPPO_20610)) {
		imgsensor_i2c_init(&psensor_inst->i2c_cfg,
			imgsensor_custom_config_19040[psensor_inst->sensor_idx].i2c_dev);
	} else if (is_project(OPPO_20630)|| is_project(OPPO_20631)|| is_project(OPPO_20632)) {
		imgsensor_i2c_init(&psensor_inst->i2c_cfg,
