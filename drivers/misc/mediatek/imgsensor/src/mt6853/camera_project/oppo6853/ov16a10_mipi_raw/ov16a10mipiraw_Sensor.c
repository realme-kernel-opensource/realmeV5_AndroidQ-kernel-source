...
static struct imgsensor_info_struct imgsensor_info = {
	...
	#endif
	.normal_video = {	//4608*3456 30fps	normal video
		.pclk = 100000000,
		.linelength = 850,
		.framelength = 3920,
		.startx = 0,
	...
	.slim_video = {	//4608*3456	30fps	slim video
		.pclk = 100000000,
		.linelength = 850,
		.framelength = 3920,
		.startx = 0,
	...
	.custom1 = {             	//3840*2160	30fps	custom1
		.pclk = 100000000,
		.linelength = 1300,	
		.framelength = 2564,
		.startx = 0,
	...
	.custom2 = {       //3840*2160	45fps	custom2
		.pclk = 100000000,
		.linelength = 850,
		.framelength = 2614,
		.startx = 0,
	...
	.custom3 = {             //1920*1080	90fps	custom3
		.pclk = 100000000,
		.linelength = 850,
		.framelength = 1306,
		.startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	{4656, 3496,    0,    0,   4656, 3496, 4656, 3496,  24,  20,  4608, 3456, 0, 0, 4608, 3456,}, /* Preview check*/
	...
	{4656, 3496,    0,    0,   4656, 3496, 2328, 1748,  524, 514,  1280, 720, 0, 0, 1280, 720,},/* hs vedio */
	{4656, 3496,    0,    0,   4656, 3496, 4656, 3496,  24,  20,  4608, 3456, 0, 0, 4608, 3456,},/* slim vedio */
	{4656, 3496,    0,    0,   4656, 3496, 4656, 3496,  408, 668,  3840, 2160, 0, 0, 3840, 2160,},//custom1
	{4656, 3496,    0,    0,   4656, 3496, 4656, 3496,  408, 668,  3840, 2160, 0, 0, 3840, 2160,},//custom2
	{4656, 3496,    0,    0,   4656, 3496, 2328, 1748,  204, 334,  1920, 1080, 0, 0, 1920, 1080,},//custom3
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[8] = {
	...
	/* 1280x720 PD:640x180, pd packet size is 288,total pd packet is 320x360.*/
    {
        0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
        0x00, 0x2b, 0x1F40, 0x1770, 0x00, 0x00, 0x0280, 0x0001,
        0x01, 0x2b, 0x0190, 0x0168, 0x03, 0x00, 0x0000, 0x0000
    },
	 /* 4608x3456 PD:1152x432, pd packet size is 288, total pd packet is 288x1728.*/
    {
        0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	...
	/* 3840x2160 PD:960x270,pd packet size is 320,total pd packet is 320x810*/
    {
        0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
        0x00, 0x2b, 0x1F40, 0x1770, 0x00, 0x00, 0x0280, 0x0001,
        0x01, 0x2b, 0x0190, 0x032a, 0x03, 0x00, 0x0000, 0x0000
    },
	/* 3840x2160 PD:960x270,pd packet size is 320,total pd packet is 320x810*/
    {
        0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
	 ...
	 /* 1920x1080 PD:960x270, pd packet size is 320,total pd packet is 320x810.*/
    {
        0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
        0x00, 0x2b, 0x1F40, 0x1770, 0x00, 0x00, 0x0280, 0x0001,
        0x01, 0x2b, 0x0190, 0x032a, 0x03, 0x00, 0x0000, 0x0000
...
static void set_shutter_frame_length(kal_uint16 shutter, kal_uint16 frame_length,kal_bool auto_extend_en)
{
	...
	if(shutter <= 0x2000)
		...
		imgsensor.frame_length= 0x2008;
	*/
	/* Shipei.Chen@Cam.Drv, 20200420,  add for shutter!*/
	...
	write_cmos_sensor(0x3501, (shutter >> 8) & 0xFF);
	write_cmos_sensor(0x3502, (shutter & 0xFE));
	// printk("ov16a10 for AE check:addr0x3500 in set_shutter_frame_length func:%x\n", read_cmos_sensor(0x3500));
	// printk("ov16a10 for AE check:addr0x3501 in set_shutter_frame_length func:%x\n", read_cmos_sensor(0x3501));
	// printk("ov16a10 for AE check:addr0x3502 in set_shutter_frame_length func:%x\n", read_cmos_sensor(0x3502));
	// printk("ov16a10 for AE check Exit! shutter =%d, framelength =%d, for flicker realtime_fps=%d\n", shutter,
		// imgsensor.frame_length, realtime_fps);
