...
void AFRegulatorCtrl(int Stage)
{
	...
	if (Stage == 0) {
		if (regVCAMAF == NULL) {
			...
			} else if (is_project(OPPO_20601) || is_project(OPPO_20660) || is_project(OPPO_20630) || is_project(OPPO_20631) || is_project(OPPO_20632)) {
		...
		if (is_project(OPPO_20601) || is_project(OPPO_20660)) {
			if (g_regVCAMAFEn == 0) {
